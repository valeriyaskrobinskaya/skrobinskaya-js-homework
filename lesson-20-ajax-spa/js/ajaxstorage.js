    ...
    $.ajax("http://fe.it-academy.by/AjaxStringStorage2.php",
        {
            ...
            cache: false,
            dataType: "json",
            data: {f: "READ", n: "Skrobinskaya_Valeriya_ajax_lesson"},
            ...
            $.ajax("http://fe.it-academy.by/AjaxStringStorage2.php",
                {
                    ...
                    cache: false,
                    dataType: "json",
                    data: {f: "INSERT", n: "Skrobinskaya_Valeriya_ajax_lesson", v: JSON.stringify(self.hashStorage)},
        ...
        $.ajax("http://fe.it-academy.by/AjaxStringStorage2.php",
            {
                ...
                cache: false,
                dataType: "json",
                data: {f: "LOCKGET", n: "Skrobinskaya_Valeriya_ajax_lesson", p: password},
            ...
            $.ajax("http://fe.it-academy.by/AjaxStringStorage2.php",
                {
                    ...
                    cache: false,
                    dataType: "json",
                    data: {f: "UPDATE", n: "Skrobinskaya_Valeriya_ajax_lesson", p: password, v: JSON.stringify(hash)},
